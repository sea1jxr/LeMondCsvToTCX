...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        ...
        <br />
        <br />
        The app was authored by <a href="mailto:converttotcx@reedjrs.com">Jeff Reed</a> and is available as open source on Github <a href="https://github.com/sea1jxr/LeMondCsvToTCX">here</a>.  It starte out as a LeMond only converter and has morphed into more so please excuse the name.  Please contact me if you have any questions, comments and\or suggestions.
    </p>
</asp:Content>
