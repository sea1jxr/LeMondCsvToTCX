...
ms speed watts rpm hr ss lss rss lpwr rpwr KM wind grade load lata rata pp cadence ss_raw
        ...
        94   5.31    22   2  80   0   0   0    0    0   0.0002    0   0.00  100    90    90      0  0  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000  0.00000")
        };
...
""9156"",""17.38"",""269"",""92"",""0"",""64"",""64"",""64"",""50"",""50"",""0.0272"",""0"",""0.00"",""0"",""86"",""87"",""0"",""0"",""0.41996"",""0.63915"",""0.91252"",""1.14235"",""1.29645"",""1.40388"",""1.41831"",""1.27468"",""0.98686"",""0.66810"",""0.41015"",""0.29158"",""0.36420"",""0.61101"",""0.93300"",""1.18463"",""1.35064"",""1.44206"",""1.42231"",""1.24684"",""0.94783"",""0.64944"",""0.42888"",""0.38219""
""12219"",""18.54"",""208"",""96"",""0"",""64"",""64"",""64"",""48"",""52"",""0.0427"",""0"",""0.00"",""0"",""91"",""92"",""0"",""0"",""0.30391"",""0.37969"",""0.57604"",""0.78212"",""0.94488"",""1.05125"",""1.09429"",""1.02206"",""0.83133"",""0.60890"",""0.41562"",""0.29380"",""0.26565"",""0.38159"",""0.59750"",""0.82256"",""1.03130"",""1.15781"",""1.17000"",""1.06487"",""0.88371"",""0.67763"",""0.46975"",""0.34617""
")
    };
        [TestMethod]
        ...
        public void ReadCsvSample()
        {
            ...
            var sample = proivder.Samples.First();
            Assert.AreEqual(60, sample.HeartRateBpm, "HeartRateBpm are wrong");
            Assert.AreEqual((uint)47, sample.TimeMilisecondElapsed, "TimeMilisecondElapsed are wrong");
            Assert.AreEqual(22, sample.PowerWatts, "PowerWatts are wrong");
            Assert.AreEqual(1, sample.CadenceRpm, "CadenceRpm are wrong");
            Assert.AreEqual(0.0001, Math.Round(sample.DistanceKilometerElapsed, 4), "DistanceKilometerElapsed are wrong");
            Assert.AreEqual(Math.Round(5.79 / ConvertDistance.KilometersPerMile, 2), Math.Round(sample.SpeedMph, 2), "SpeedMph are wrong");
        }        

        [TestMethod]
        public void ReadFirstFixedWidthSample()
        {
            var proivder = new CompuTrainerTXTFileProvider(fixedWidth);
            var sample = proivder.Samples.First();
            Assert.AreEqual(60, sample.HeartRateBpm, "HeartRateBpm are wrong");
